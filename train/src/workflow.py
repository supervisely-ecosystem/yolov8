...
class Workflow:
    ...
    def add_output(self, model_filename: str, team_files_dir: str, best_filename: str):
        try:
            ...
            sly.logger.debug(f"Workflow Output: Model filename - {model_filename}, Team Files dir - {team_files_dir}, Best filename - {best_filename}")
            ...
            if best_filename_info:
                ...
                sly.logger.debug(f"File {best_filename_info.path} not found in Team Files. Cannot set workflow output.")
        except Exception as e:
