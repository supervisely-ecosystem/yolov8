...
class YOLO(CustomModel):
    """YOLO (You Only Look Once) object detection model."""

    def __init__(self, model="yolov8n.pt", task=None, verbose=False, stop_event=None):
        ...
        if "-world" in path.stem and path.suffix in {
            ...
            super().__init__(
                model=model, task=task, verbose=verbose, stop_event=stop_event
            )
